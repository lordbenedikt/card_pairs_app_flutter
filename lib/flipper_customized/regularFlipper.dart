...
class FlipperState extends State<Flipper> with SingleTickerProviderStateMixin {
  ...
  Animation<double>? animationVertical, animationHorizontal;
    ...
    switch (widget.controller.dragAxis) {
      case DragAxis.horizontal:
        transform = Matrix4.identity()
          ..setEntry(3, 2, 0.001)
          ..rotateY(
              dragHorizontal / 180 * pi + (widget.startFaceDown ? pi : 0));
        break;
      case DragAxis.vertical:
        transform = Matrix4.identity()
          ..setEntry(3, 2, 0.001)
          ..rotateX(dragVertical / 180 * pi + (widget.startFaceDown ? pi : 0));
        // ..rotateY(dragVertical / 180 * pi + pi);
        break;
      case DragAxis.both:
        transform = Matrix4.identity()
          ..setEntry(3, 2, 0.001)
        ...
        Transform(
          ...
          child: ClipRRect(
            ...
            child: Container(
              ...
              child: (widget.startFaceDown ? !isFront : isFront)
                  ? widget.front
                  : Transform(
  ...
  bool isFrontVisible() {
    return widget.startFaceDown ? !isFront : isFront;
  }
