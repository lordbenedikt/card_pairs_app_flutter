...
class FlipperController extends ChangeNotifier {
  ...
  bool isFrontVisible() {
    ...
    return _state!.isFrontVisible();
  }

  bool isAnimationCompleted() {
    if (_state == null) return true;
    if (_state!.animationHorizontal != null) {
      if (!_state!.animationHorizontal.isCompleted) {
        return false;
      }
    }
    if (_state!.animationVertical != null) {
      if (!_state!.animationVertical.isCompleted) {
        return false;
      }
    }
    return true;
